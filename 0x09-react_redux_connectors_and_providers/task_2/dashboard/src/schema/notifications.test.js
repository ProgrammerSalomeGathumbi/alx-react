...
describe('getAllNotificationsByUser', () => {
  it('returns notifications for a specific user', () => {
    ...
    const result = getAllNotificationsByUser(userId, normalizedData.entities);

    expect(result).toEqual(expect.arrayContaining(expectedNotifications));
  });

  it('verifies normalized data result array', () => {
    const expectedIds = [
    ...
    expect(Object.keys(normalizedData.entities.notifications)).toEqual(expectedIds);
  });

  it('verifies normalized data users entity', () => {
    const userId = '5debd764a7c57c7839d722e9';
    const expectedUser = {
      age: 25,
  ...
  it('verifies normalized data messages entity', () => {
  ...
  it('verifies normalized data notifications entity', () => {
